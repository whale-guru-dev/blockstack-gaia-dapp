            ...
            <b-tab title="My Portfolio" lazy>
              <b-card-text>
                ...
                <b-row class="my-1">
                  ...
                  <b-col sm="3">
                    <b-form-input id="totalAmount" v-model="totalPortfolioValue" class="totalAmountInput" readonly></b-form-input>
                  </b-col>
                </b-row>
                <b-table
                  sticky-header
...
export default {
  methods: {
    ...
    changeHoldingAmount: async function(value, id) {
      ...
      this.totalPortfolioValue = this.portfolioData.reduce((a,b) => {
        return a.quote.USD.price * a.amount + b.quote.USD.price * b.amount
      });
